...
<title>Toko Buah 100% Real</title>
<body>
    <nav class="navbar navbar-dark bg-dark">
            <span class="navbar-brand mb-0 h1">SEVA KHAIRUL ROHMAN</span>
        </div>
    </nav>
<div class="container">
    <br>
...
<?php
    ...
    if (isset($_GET['id_barang'])) {
        ...
        $sql="delete from tbl_sevastok where id_barang='$id_barang' ";
...
?>
     ...
     <tr class="table-danger">
       ...
       <table class="my-3 table table-bordered">
        ...
        $sql="select * from tbl_sevastok order by id_barang desc";
